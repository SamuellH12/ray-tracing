...
int main(){
    ...
    objs.emplace_back(esfera(point(0, 0, 5), 2, vetor(1, 1, 0)));
    objs.emplace_back(esfera(point(2, 0, 5), 1, vetor(1, 0, 1)));
    objs.emplace_back(esfera(point(-2, 0, 5), 1.3, vetor(0, 1, 1)));
    objs.emplace_back(plano(point(0, 0, 0), vetor(1, 0, 0), vetor(1, 1, 0)));
